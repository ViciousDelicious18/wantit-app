...
const styles = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; -webkit-font-smoothing: antialiased; }
  ...
  html[data-dark="true"] .hero { background: linear-gradient(to bottom, rgba(4,14,28,0.68) 0%, rgba(6,22,42,0.42) 45%, rgba(4,14,28,0.65) 100%), url('/skytower.jpg') 0% 50% / 130% auto no-repeat !important; }
